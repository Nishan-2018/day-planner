      ...
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white dark:bg-zinc-900 p-8 shadow-md">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
            {isLoginMode ? 'Sign in to Day Planner' : 'Create an account'}
          </h2>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={isLoading}
              className="flex w-full items-center justify-center gap-3 rounded-md bg-white dark:bg-zinc-800 px-3 py-2.5 text-sm font-semibold text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-700 focus-visible:ring-transparent transition-colors disabled:opacity-50"
            >
